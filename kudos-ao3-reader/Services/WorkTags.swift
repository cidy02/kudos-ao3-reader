...
enum WorkTags {
    ...
    static func refreshFromAO3(for work: SavedWork, in context: ModelContext) async {
        ...
        do {
            ...
            work.workFreeforms = TagMerge.merged(work.workFreeforms, groups.freeforms)
            work.workWarnings = TagMerge.merged(work.workWarnings, groups.warnings)
            work.workCategories = TagMerge.merged(work.workCategories, groups.categories)
            ...
            work.workFreeforms.removeAll {
                categorizedKeys.contains(TagMerge.key($0))
            }
            ...
            work.workTags = TagMerge.merged([], work.workFandoms + work.workRelationships
