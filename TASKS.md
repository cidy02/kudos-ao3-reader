...
|----|------|-------|--------|--------|-------------------|
| T-55 | **Native iOS UI refinement pass** — Library work cards contain the full compact work summary; Browse category/card and fandom-row polish; Work Detail consistency check; calm native visual pass without AO3 behavior changes. | Codex | `feature/native-ao3-actions` | 🔄 IN PROGRESS | Implement requested UI-only refinements; preserve AO3 metadata/actions/navigation and avoid risky refactors. |
