...
|----|------|-------|--------|--------|-------------------|
| T-56 | **Expanded result tags + Library card depth follow-up** — ensure expanded AO3 work rows show non-duplicated Additional Tags after Characters; strengthen Library/Home work card separation from themed backgrounds. | Codex | `feature/native-ao3-actions` | 🔄 IN PROGRESS | Keep changes UI-only; preserve AO3 metadata/actions/navigation and avoid network/model refactors. |
