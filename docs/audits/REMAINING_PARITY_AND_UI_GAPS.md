...
| Authors, Inbox hub, AO3 remote collections, non-EPUB, folder sync | **Still missing** |
| Reader device polish / series bulk download UI | **Partial** |
...
| AO3 Collections (remote) | ❌ | P2 | Still missing |
...
| Custom font import UI | 🟡 | P2 | Store exists |
| Reading statistics | ✅ W2 | — | Insights screen |
| Authors profiles | ❌ | **P1** | Wave 3 |
| Inbox / comments hub | ❌ | **P1** | Wave 3 |
...
### Wave 3 (remaining product parity)
1. Author profile surface (AO3 user/works lists)  
2. Inbox / comments hub (if iOS has dedicated surface)  
3. AO3 remote collections list  
4. Series “download all” enqueue into DownloadQueue  
5. Non-EPUB converters  
6. Custom font import Settings UI  
7. Reader device polish (progress pill, chrome)  
8. Biometric reveal for mature works
