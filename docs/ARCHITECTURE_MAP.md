...
| `.kudosbackup` archive (single ZIP: manifest v7 + EPUB/font blobs; legacy package read-only), restore merge rules, tombstone index, `WorkRestoreIndex` | `Services/KudosBackup.swift` |
